...
// async
export syntax samakalikarana = ctx => #`async`;

// await
export syntax veci_undandi = ctx => #`await`;

// new
export syntax kotta = ctx => #`new`;

// promise
export syntax Vagdanam = ctx => #`Promise`;

// exec_after
export syntax amalu_tarvata = ctx => #`setTimeout`;
